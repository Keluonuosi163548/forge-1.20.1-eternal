...
public class ModZhCnLangProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add("tooltip.eternallovemod.love_ring_item.shift_sophisticatedbackpacks","§4此物品不会被精妙背包的磁铁升级吸取");
        add("tooltip.eternallovemod.love_ring_item.shift_goety_revelation","§4此物品免疫亚波伦-末日终结的饰品夺取");
        add("tooltip.eternallovemod.love_ring_item.shift_l2hostility","§4此物品无视莱特兰-恶意的诸神黄昏封印");
        ...
        add("tooltip.eternallovemod.eternal_love_ring_item.shift_goety_revelation","§4此物品免疫亚波伦-末日终结的饰品夺取\n");
    }
}
