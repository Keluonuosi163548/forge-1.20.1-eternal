...
public class ModEnUsLangProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add("tooltip.eternallovemod.love_ring_item.shift_l2hostility","§4This item is immune to L2hostility's Gods' Reckoning");
